...
<body>
  <div class="container">
    <div class="main_content">
      <div class="picture">
        <div class=main_picture>
          <img src="${product.img}" id="first_img">
        </div>
        <div class="btn_box">
        ...
        <c:forEach var="subimg" items="${subimgs}">
        <div class="sub_picture">
          <img src="${subimg.subimg0}" class="subpicture">
          <img src="${subimg.subimg1}" class="subpicture">
          <img src="${subimg.subimg2}" class="subpicture">
          <img src="${subimg.subimg3}" class="subpicture">
          <img src="${subimg.subimg4}" class="subpicture">
          <img src="${subimg.subimg5}" class="subpicture">
        </div>
        </c:forEach>
      </div>
      <div class="tittle" id="first_tittle"><h2 class="tittletext">정보</h2><hr></div>
        <div class="info">
      ...
      <div class="tittle"><h2 class="tittletext">세부정보</h2><hr>
      ...
      <div class="tittle"><h2 class="tittletext">리뷰</h2><hr></div>
      <div class="other_product">
      <h3 id=lasttext>맞춤형 추천제품</h3>
        <div class="slide">
   ...
   <div class="sidebar">
     <form class="productdata_form">
     <input type="hidden" value="${product.id}" id="cart_productid">
     <div class="product_text">${product.brand_name}</div>
     ...
     <div class="product_text">
       ...
       <h3 id="cart_productprice">${product.price}원</h3>
  
       <h4 id="cart_productcolor">${product.color}</h4>
     </div>
     <div class="product_text" id="size">구입 가능한 사이즈
      ...
      <tr>
          ...
          <option selected value="0" >-----사이즈-----</option>
   ...
   <div class="cart">
     <div class="cart_text1"><button onclick="basket1.input()"><h4>장바구니 담기→</h4></button></div>
